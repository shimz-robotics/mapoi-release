...
Name:           ros-humble-mapoi-turtlebot3-example
Version:        0.6.0
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS mapoi_turtlebot3_example package

License:        MIT
URL:            https://index.ros.org/p/mapoi_turtlebot3_example/#humble
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-ament-cmake-auto
Requires:       ros-humble-ament-index-cpp
Requires:       ros-humble-geometry-msgs
Requires:       ros-humble-mapoi-interfaces
Requires:       ros-humble-mapoi-rviz-plugins
Requires:       ros-humble-mapoi-server
Requires:       ros-humble-mapoi-webui
...
Requires:       ros-humble-turtlebot3
Requires:       ros-humble-turtlebot3-gazebo
Requires:       ros-humble-turtlebot3-navigation2
...
BuildRequires:  ros-humble-mapoi-interfaces
...
%changelog
* Wed Jul 15 2026 Shunsuke Kimura <kimura.shunsuke@shimz.co.jp> - 0.6.0-2
- Autogenerated by Bloom

* Wed Jul 15 2026 Shunsuke Kimura <kimura.shunsuke@shimz.co.jp> - 0.6.0-1
- Autogenerated by Bloom
