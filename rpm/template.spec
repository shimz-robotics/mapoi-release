...
Name:           ros-jazzy-mapoi-turtlebot3-example
Version:        0.6.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS mapoi_turtlebot3_example package

License:        MIT
URL:            https://index.ros.org/p/mapoi_turtlebot3_example/#jazzy
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-jazzy-ament-cmake-auto
Requires:       ros-jazzy-ament-index-cpp
Requires:       ros-jazzy-geometry-msgs
Requires:       ros-jazzy-mapoi-interfaces
Requires:       ros-jazzy-mapoi-rviz-plugins
Requires:       ros-jazzy-mapoi-server
Requires:       ros-jazzy-mapoi-webui
...
Requires:       ros-jazzy-turtlebot3
Requires:       ros-jazzy-turtlebot3-gazebo
Requires:       ros-jazzy-turtlebot3-navigation2
...
BuildRequires:  ros-jazzy-mapoi-interfaces
